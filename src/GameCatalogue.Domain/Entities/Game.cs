...
namespace GameCatalogue.Domain.Entities
{
    public sealed class Game : Entity
    {
        ...
        private void ValidateDomain(string name, string producer, string gender, int quantity, string image)
        {
            ...
            DomainExceptionValidation.When(string.IsNullOrEmpty(producer),
                "Invalid producer. Producer is required");

            DomainExceptionValidation.When(producer.Length < 5,
                "Invalid producer, too short, minimum 5 characters");
